package com.base.devices.broadcast;
...
import com.base.devices.data.BatteryStatusData;
...
import static com.base.devices.utils.OtherUtils.getBrightness;
...
//            batteryStatusData.device_id = getDeviceid();
            batteryStatusData.is_usb_charge = (status == BATTERY_PLUGGED_USB) ? 1 : 0;
            batteryStatusData.is_ac_charge = (status == BATTERY_PLUGGED_AC) ? 1 : 0;
