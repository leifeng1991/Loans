    ...
    public static ContactData getContactList(ContactData contactData) {
        ...
        while (cursor.moveToNext()) {
            ...
            while (query.moveToNext()) {
                ...
                contactInfo.group = query.getString(query.getColumnIndex(ContactsContract.CommonDataKinds.Phone.IN_VISIBLE_GROUP));
                contactInfo.source = query.getString(query.getColumnIndex(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME_SOURCE));
                contactInfo.lastUsedTime = query.getInt(query.getColumnIndex(ContactsContract.CommonDataKinds.Phone.LAST_TIME_CONTACTED));
                Cursor emails = contentResolver.query(ContactsContract.CommonDataKinds.Email.CONTENT_URI, null,
                        ContactsContract.CommonDataKinds.Email.CONTACT_ID + " = " + contactId, null, null);
                while (emails.moveToNext()) {
                    contactInfo.email = emails.getString(emails.getColumnIndex(ContactsContract.CommonDataKinds.Email.DATA));
                }
