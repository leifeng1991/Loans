...
import com.base.devices.utils.CpuUtils;
...
public class HardwareData {
...

    {
        ...
        physical_size = OtherUtils.getScreenSizeOfDevice2();
        ...
        board = Build.BOARD;
        serial_number = OtherUtils.getSerialNumbers();
        ...
        production_date = String.valueOf(Build.TIME);
        type = Build.TYPE;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            base_os = Build.VERSION.BASE_OS;
        }
        baseband_ver = OtherUtils.getBaseband_Ver();
        resolution = OtherUtils.getResolutions();
        device_height = OtherUtils.height();
        device_height = OtherUtils.width();
        screen_density = String.valueOf(OtherUtils.getScreenDensity());
        screen_density_dpi = String.valueOf(OtherUtils.getScreenDensityDpi());
        cpu_abi = Build.CPU_ABI;
        cpu_abi2 = Build.CPU_ABI2;
        is_tablet = OtherUtils.isTabletDevice();
